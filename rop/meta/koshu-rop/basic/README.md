...
|-- ROP  /n 8  /group "cox-gadget"  /rop {= /n /name /usage [ 1 | "const" | "const R" ] [ 2 | "geo-datum-jp" | "geo-datum-jp E E E -to /N /N" ] [ 3 | "geo-degree" | "geo-degree /N /P /P /P" ] [ 4 | "interp" | "interp E" ] [ 5 | "number" | "number /N -order /N ..." ] [ 6 | "rank" | "rank /N -order /N ..." ] [ 7 | "repeat" | "repeat N R" ] =}
...
|-- ROP  /n 12  /group "nest"  /rop {= /n /name /usage [ 1 | "chunk" | "chunk /T ... [-order /P ...]" ] [ 2 | "copy" | "copy N R" ] [ 3 | "down" | "down /N" ] [ 4 | "for" | "for /N R" ] [ 5 | "group" | "group R -to /N " ] [ 6 | "hier" | "hier /P ... -to /N" ] [ 7 | "join-up" | "join-up /P ..." ] [ 8 | "nest" | "nest [~] /P ... -to /N" ] [ 9 | "opp-group" | "opp-group R -to /N" ] [ 10 | "pick-group" | "pick-group /P ... -to /N" ] [ 11 | "slice" | "slice /N [R]" ] [ 12 | "slice-up" | "slice-up R" ] [ 13 | "ungroup" | "ungroup /P" ] [ 14 | "up" | "up /N" ] =}
|-- ROP  /n 13  /group "peripheral"  /rop {= /n /name /usage [ 1 | "index-elem" | "index-elem /N /N /P" ] [ 2 | "member" | "member /N /N" ] [ 3 | "rdf" | "rdf P /S /O" ] [ 4 | "term-name" | "term-name /N" ] [ 5 | "tie" | "tie /P ... -to N" ] [ 6 | "today" | "today /N" ] [ 7 | "uncollect" | "uncollect /P -to /N ..." ] [ 8 | "untie" | "untie /P -only /P ..." ] =}
...
|-- ROP  /n 16  /group "term"  /rop {= /n /name /usage [ 1 | "backward" | "backward /P ..." ] [ 2 | "cut" | "cut /P ..." ] [ 3 | "cut-term" | "cut-term /R" ] [ 4 | "forward" | "forward /P ..." ] [ 5 | "lexical" | "lexical" ] [ 6 | "move" | "move /P ... -to /N ..." ] [ 7 | "pick" | "pick /P ..." ] [ 8 | "pick-term" | "pick-term /R" ] [ 9 | "prefix" | "prefix /P /N ..." ] [ 10 | "prefix-change" | "prefix-change /P /Q" ] [ 11 | "rename" | "rename /N /P ..." ] [ 12 | "unprefix" | "unprefix /P" ] [ 13 | "wipe" | "wipe" ] =}
...
TABLE : ROP
  ...
  8    "cox-gadget"     /n   /name                     /usage
                        ...
                        4    "interp"                  "interp E"
                        5    "number"                  "number /N -order /N ..."
                        6    "rank"                    "rank /N -order /N ..."
                        7    "repeat"                  "repeat N R"
  ...
  12   "nest"           /n   /name                     /usage
                        ...
                        7    "join-up"                 "join-up /P ..."
                        8    "nest"                    "nest [~] /P ... -to /N"
                        9    "opp-group"               "opp-group R -to /N"
                        10   "pick-group"              "pick-group /P ... -to /N"
                        11   "slice"                   "slice /N [R]"
                        12   "slice-up"                "slice-up R"
                        13   "ungroup"                 "ungroup /P"
                        14   "up"                      "up /N"
                        
  13   "peripheral"     /n   /name                     /usage
                        ---- ------------------------- ---------------------------------------------------------
                        1    "index-elem"              "index-elem /N /N /P"
                        2    "member"                  "member /N /N"
                        3    "rdf"                     "rdf P /S /O"
  ...
  16   "term"           /n   /name                     /usage
                        ...
                        6    "move"                    "move /P ... -to /N ..."
                        7    "pick"                    "pick /P ..."
                        8    "pick-term"               "pick-term /R"
                        9    "prefix"                  "prefix /P /N ..."
                        10   "prefix-change"           "prefix-change /P /Q"
                        11   "rename"                  "rename /N /P ..."
